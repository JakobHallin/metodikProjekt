/****************************************************************************
** Meta object code from reading C++ file 'Stock.class.h'
**
...
#error "The header file 'Stock.class.h' doesn't include <QObject>."
...
void Stock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Stock::*)(int );
            if (_t _q_method = &Stock::amountChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Stock::amountChanged(int _t1)
{
