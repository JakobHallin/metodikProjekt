/****************************************************************************
** Meta object code from reading C++ file 'Account.class.h'
**
...
#error "The header file 'Account.class.h' doesn't include <QObject>."
...
void Account::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Account::*)(float );
            if (_t _q_method = &Account::balanceChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Account::balanceChanged(float _t1)
{
